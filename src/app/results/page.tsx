    ...
    return (
        <div className="flex flex-col min-h-screen bg-black text-white">
            ...
            <main className="flex-1 pt-32">
                ...
                <section className="relative py-20 overflow-hidden">
                    ...
                    <div className="max-w-7xl mx-auto px-10 relative z-10 text-center">
                        ...
                        <h1 className="text-5xl md:text-7xl font-bold font-sora mb-8 leading-tight">
                            ...
                            <span className="text-secondary">Measured in Impact</span>
                        </h1>
                        <p className="text-gray-400 max-w-3xl mx-auto text-xl font-space-grotesk leading-relaxed">
                            We don't just ship code; we deliver business outcomes. Explore how our strategic software engineering has powered growth for industry leaders.
                        </p>
                    </div>
                ...
                {/* Results Component (Metrics + Case Studies) */}
                <Results />

                {/* Bottom CTA */}
                <section className="py-24 border-t border-white/5">
                    <div className="max-w-4xl mx-auto px-10 text-center">
                        <h2 className="text-3xl font-bold font-sora mb-6">Want to see these results for your business?</h2>
                        <p className="text-gray-400 mb-10 text-lg">Let's analyze your current digital landscape and build a growth roadmap.</p>
